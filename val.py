...
if __name__ == '__main__':
    model_path = '/root/RTDETR/runs/prune/exp_rtdetr-r18-MutilBackbone-DAF-prune80%_vmup2400_250414-finetune/weights/best.pt'
    model = RTDETR(model_path) # 选择训练好的权重路径
    result = model.val(data='/root/RTDETR/datasets/data.yaml',
